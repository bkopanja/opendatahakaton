 ...
 */
public class GetFeedsAsyncTask extends AsyncTask<String, Void, JSONObject> {

    public static final MediaType JSON = MediaType.parse("application/json; charset=utf-8");
    private String apiUrl = Constants.API_ROOT + "get_feed";

    private DeferredObject<JSONObject, Void, Void> deferredObject;
    private Context context;
    private GoogleSignInAccount account;

    public GetFeedsAsyncTask(Context context) {
